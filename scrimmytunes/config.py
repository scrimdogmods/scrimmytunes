...
class Config:
    ...
    def __init__(self, config_file: pathlib.Path) -> None:
        ...
        :raises: ScrimmyTunes.exceptions.HelpfulError
        ...
        self._debug_level: DebugLevel = self.register.init_option(
            section="ScrimmyTunes",
            option="DebugLevel",
            dest="_debug_level",
            default=ConfigDefaults._debug_level(),
            getter="getdebuglevel",
            comment=(
                "Set the log verbosity of Scrimmy Tunes. Normally this should be set to INFO.\n"
        ...
        self.spotify_clientid = self.register.init_option(
            ...
            comment="Provide an optional Spotify Client ID to enable Scrimmy Tunes to interact with Spotify API.",
            editable=False,
        )
        self.spotify_clientsecret = self.register.init_option(
            ...
            comment="Provide an optional Spotify Client Secret to enable Scrimmy Tunes to interact with Spotify API.",
            editable=False,
        )
        ...
        self.dev_ids: Set[int] = self.register.init_option(
            ...
            comment=(
                "A list of Discord User ID numbers who can remotely execute code using Scrimmy Tunes dev-only commands. "
                "Warning, you should only set this if you plan to do development of Scrimmy Tunes!"
            ),
            getter="getidset",
            editable=False,
        )
        ...
        self.bot_exception_ids: Set[int] = self.register.init_option(
            ...
            comment="Discord Member IDs for other bots that Scrimmy Tunes should not ignore.  All bots are ignored by default.",
        )
        ...
        self.command_prefix: str = self.register.init_option(
            ...
            comment="Command prefix is how all Scrimmy Tunes commands must be started",
        )
        ...
        self.bound_channels: Set[int] = self.register.init_option(
            ...
            getter="getidset",
            comment=(
                "ID numbers for text channels that Scrimmy Tunes should exclusively use for commands."
        ...
        self.unbound_servers: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Allow Scrimmy Tunes to respond in all text channels of a server, when no channels are set in BindToChannels option.",
        )
        self.autojoin_channels: Set[int] = self.register.init_option(
            ...
            getter="getidset",
            comment="A list of Voice Channel IDs that Scrimmy Tunes should automatically join on start up.",
        )
        self.dm_nowplaying: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Scrimmy Tunes will try to send Now Playing notices directly to the member who requested the song instead of posting in server channel.",
        )
        ...
        self.nowplaying_channels: Set[int] = self.register.init_option(
            ...
            getter="getidset",
            comment="Forces Scrimmy Tunes to use a specific channel to send now playing messages. One text channel ID per server.",
        )
        self.delete_nowplaying: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Scrimmy Tunes will automatically delete Now Playing messages.",
        )
        ...
        self.default_volume: float = self.register.init_option(
            ...
            getter="getpercent",
            comment=(
                "Sets the default volume level Scrimmy Tunes will play songs at. "
        ...
        self.default_speed: float = self.register.init_option(
            ...
            getter="getfloat",
            comment=(
                "Sets the default speed Scrimmy Tunes will play songs at.\n"
        ...
        self.save_videos: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Allow Scrimmy Tunes to keep downloaded media, or delete it right away.",
        )
        ...
        self.auto_playlist: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Enable Scrimmy Tunes to automatically play music from the autoplaylist.txt",
        )
        ...
        self.auto_pause: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Scrimmy Tunes will automatically pause playback when no users are listening.",
        )
        self.delete_messages: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Allow Scrimmy Tunes to automatically delete messages it sends, after a short delay.",
        )
        ...
        self.persistent_queue: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Allow Scrimmy Tunes to save the song queue, so they will survive restarts.",
        )
        self.pre_download_next_song: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment=(
                "Enable Scrimmy Tunes to download the next song in the queue while a song is playing.\n"
        ...
        self.write_current_song: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="If enabled, Scrimmy Tunes will save the track title to:  data/{server_ID}/current.txt",
        )
        ...
        self.embeds: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Allow Scrimmy Tunes to format it's messages as embeds.",
        )
        ...
        self.remove_ap: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Enable Scrimmy Tunes to automatically remove unplayable entries from tha auto playlist.",
        )
        self.show_config_at_start: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Display Scrimmy Tunes config settings in the logs at startup.",
        )
        ...
        self.leavenonowners: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="If enabled, Scrimmy Tunes will leave servers if the owner is not in their member list.",
        )
        self.usealias: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="If enabled, Scrimmy Tunes will allow commands to have multiple names using data in:  config/aliases.json",
        )
        self.footer_text: str = self.register.init_option(
            ...
            comment="Replace Scrimmy Tunes name/version in embed footer with custom text. Only applied when UseEmbeds is enabled and it is not blank.",
        )
        self.self_deafen: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Scrimmy Tunes will automatically deafen itself when entering a voice channel.",
        )
        self.leave_inactive_channel: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="If enabled, Scrimmy Tunes will leave a voice channel when no users are listening, after waiting for a period set in LeaveInactiveVCTimeOut.",
        )
        ...
        self.leave_after_queue_empty: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="If enabled, Scrimmy Tunes will leave the channel immediately when the song queue is empty.",
        )
        self.leave_player_inactive_for: float = self.register.init_option(
            ...
            getter="getduration",
            comment="Scrimmy Tunes will wait for this period of time before leaving voice channel when player is not playing or is paused. Set to 0 to disable.",
        )
        ...
        self.enable_options_per_guild: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Allow Scrimmy Tunes to save a per-server command prefix, and enables setprefix command.",
        )
        ...
        self.round_robin_queue: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="If enabled and multiple members are adding songs, Scrimmy Tunes will organize playback for one song per member.",
        )
        ...
        self.enable_network_checker: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment=(
                "Allow Scrimmy Tunes to use system ping command to detect network outage and availability.\n"
                "This is useful if you keep the bot joined to a channel or playing music 24/7.\n"
                "Scrimmy Tunes must be restarted to enable network testing.\n"
        ...
        self.enable_queue_history_global: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Enable saving all songs played by Scrimmy Tunes to a playlist, history.txt",
        )
        ...
        self.auto_unpause_on_play: bool = self.register.init_option(
            ...
            getter="getboolean",
            comment="Allow Scrimmy Tunes to automatically unpause when play commands are used.",
        )
        ...
        self.audio_cache_path: pathlib.Path = self.register.init_option(
            ...
            getter="getpathlike",
            comment="An optional directory path where Scrimmy Tunes will store long and short-term cache for playback.",
        )
    ...
    def run_checks(self) -> None:
        ...
        if not self._login_token:
            ...
            env_token = os.environ.get("SCRIMMYTUNES_TOKEN")
            if env_token:
                ...
                raise HelpfulError(
                    ...
                    "See https://github.com/Just-Some-Bots/ScrimmyTunes/wiki/FAQ for info.",
                    preface=self._confpreface,
                )
        ...
        if self.cookies_path.is_file():
            log.warning(
                "Cookies TXT file detected. ScrimmyTunes will pass them to yt-dlp.\n"
    ...
    async def async_validate(self, bot: "ScrimmyTunes") -> None:
        """
        ...
        if not bot.user:
            log.critical("ScrimmyTunes does not have a user instance, cannot proceed.")
        ...
        if not config.read(self.config_file, encoding="utf-8"):
            ...
            try:
                ...
                if not owner_id.isdigit() and owner_id != "auto":
                    ...
                    raise RuntimeError("ScrimmyTunes cannot proceed with this config.")
...
class ConfigOption:
    ...
    def __init__(
        ...
        """
        Defines a configuration option in ScrimmyTunes and attributes used to
...
class UserBlocklist(Blocklist):
    def __init__(self, blocklist_file: pathlib.Path, comment_char: str = "#") -> None:
        ...
        create_file_ifnoexist(
            blocklist_file,
            [
                f"{c} Scrimmy Tunes discord user block list denies all access to bot.\n",
...
class SongBlocklist(Blocklist):
    def __init__(self, blocklist_file: pathlib.Path, comment_char: str = "#") -> None:
        ...
        create_file_ifnoexist(
            blocklist_file,
            [
                f"{c} Scrimmy Tunes discord song block list denies songs by URL or Title.\n",
