...
DEFAULT_FOOTER_TEXT: str = f"Scrimmy Tunes Version 1.0"
DEFAULT_BOT_NAME: str = "Scrimmy Tunes"
DEFAULT_BOT_ICON: str = "http://afog.site/scrimmytunes/img/st.png"
DEFAULT_OWNER_GROUP_NAME: str = "Owner (auto)"
DEFAULT_PERMS_GROUP_NAME: str = "Default"
# This UA string is used by ScrimmyTunes only for the aiohttp session.
# Meaning discord API and spotify API communications.
# NOT used by ytdlp, they have a dynamic UA selection feature.
SCRIMMYTUNES_USER_AGENT_AIOHTTP: str = f"Scrimmy Tunes/V1.0"
...
DEFAULT_SCRIMMYTUNES_LOG_FILE: str = "logs/ScrimmyTunes.log"
...
# Maximum number of threads ScrimmyTunes will use for downloading and extracting info.
