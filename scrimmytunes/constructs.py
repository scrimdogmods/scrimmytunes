...
class GuildSpecificData:
    ...
    def command_prefix(self) -> str:
        ...
        Otherwise the default command prefix is returned from ScrimmyTunes config.
        """
...
class SkipState:
    ...
    def __init__(self) -> None:
        """
        Manage voters and their ballots for fair ScrimmyTunes track skipping.
...
class Response:
    ...
    def __init__(
        ...
        """
        Helper class intended to be used by command functions in ScrimmyTunes.
