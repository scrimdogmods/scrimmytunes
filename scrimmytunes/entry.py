...
from .exceptions import ExtractionError, InvalidDataError, ScrimmyTunesException
    ...
    def __init__(
        ...
        if self.duration is None:
            log.info(
                ...
                "ScrimmyTunes cannot estimate queue times until it is downloaded.\n"
                "Entry name:  %s",
                self.title,
            )
        ...
        try:
            ...
            if self.duration is None:
                ...
                if not self.duration:
                    log.error(
                        "ScrimmyTunes could not get duration data for this entry.\n"
    ...
    async def _really_download(self) -> None:
        ...
        for attempt in range(1, 4):
            ...
            try:
                ...
                raise ScrimmyTunesException(str(e)) from e
