...
class ScrimmyTunesException(Exception):
...
class CommandError(ScrimmyTunesException):
    pass


# Something went wrong during the processing of a song/ytdl stuff
class ExtractionError(ScrimmyTunesException):
    pass


# Something is wrong about data
class InvalidDataError(ScrimmyTunesException):
    pass
...
class FFmpegError(ScrimmyTunesException):
    pass


# FFmpeg complained about something but we don't care
class FFmpegWarning(ScrimmyTunesException):
    pass
...
class HelpfulError(ScrimmyTunesException):
    def __init__(
        self,
        issue: str,
        solution: str,
