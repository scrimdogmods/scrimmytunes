...
class PermissionGroup:
    def __init__(
        ...
        self.ignore_non_voice = self._mgr.register.init_option(
            ...
            comment=(
                "List of command names that can only be used while in the same voice channel as Scrimmy Tunes.\n"
        ...
        self.extractors = self._mgr.register.init_option(
            ...
            comment=(
                ...
                "ScrimmyTunes also provides one custom service `spotify:ScrimmyTunes` to enable or disable spotify API extraction.\n"
                "NOTICE: ScrimmyTunes might not support all services available to yt_dlp!\n"
            ),
            empty_display_val="(All allowed)",
        )
