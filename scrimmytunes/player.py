...
class MusicPlayer(EventEmitter, Serializable):
    def __init__(
        ...
        :param: bot:  A ScrimmyTunes discord client instance.
    ...
    def _playback_finished(self, error: Optional[Exception] = None) -> None:
        ...
        # finally, tell the rest of ScrimmyTunes that playback is done.
    ...
    def _deserialize(
        ...
        bot: Optional["ScrimmyTunes"] = None,
    ...
    def from_json(
        cls,
        raw_json: str,
        bot: "ScrimmyTunes",  # pylint: disable=unused-argument
...
def check_stderr(data: bytes) -> bool:
    ...
    :raises: ScrimmyTunes.exceptions.FFmpegWarning
        If a warning level message was detected in the `data`
    :raises: ScrimmyTunes.exceptions.FFmpegError
