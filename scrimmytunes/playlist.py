...
class Playlist(EventEmitter, Serializable):
    ...
    async def estimate_time_until(
        ...
        :raises: ScrimmyTunes.exceptions.InvalidDataError  if duration data cannot be calculated.
        """
    ...
    @classmethod
    def _deserialize(
        cls, raw_json: Dict[str, Any], bot: Optional["ScrimmyTunes"] = None, **kwargs: Any
    ) -> "Playlist":
